...
export default function Home(){
    ...
    const dadosProtetor = [
        {
            poster: require('../../assets/BioBioProtetorSolar.png'),
            nome: "SUNNATURE",
            preco: "R$ 124,90",
        },
        {
            poster: require('../../assets/KhorProtetorSolar.png'),
            nome: "Khor FPS 15",
            preco: "R$ 79,30",
            link: {uri:'https://khorcosmetics.com/produtos/protetor-solar-natural-fps15-uva8-khor-50g/'}
        },
        {
            poster: require('../../assets/MamiWata.png'),
    ...
    const dadosSerum = [
        {
            poster: require('../../assets/BaobaSerum.png'),
            nome: "Baobá 20 ml",
            preco: "R$ 52,00",
            link: {uri: 'https://www.baobasaboaria.com.br/serum-facial-peles-secas?variant_id=243'}
        },
        {
            poster: require('../../assets/HidratanteCalmRose.png'),
            nome: "Hidratante Calm Rose",
            preco: "R$ 65,00",
            link: {uri: 'https://www.baobasaboaria.com.br/serum-facial-peles-secas?variant_id=243'}
        },
        {
            poster: require('../../assets/SimpleOrganic.png'),
            nome: "Simple Organic",
            preco: "R$ 135,00",
    ...
    return(
       ...
       <View showsVerticalScrollIndicator={true} style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Pressable style={{position: 'absolute', right: 0, alignSelf: 'center', marginTop: '5%' }} onPress={() => alert ("Em breve você terá uma melhor experiência com novas funcionalidades") }>
                    <Entypo
                        name="menu"
                        size={24}
                        color={'#32B1CA'}
        ...
        <ScrollView>
            <View style={styles.containerSession}>
                ...
                <FlatList showsHorizontalScrollIndicator={false} style={styles.section} horizontal data={dadosProtetor} renderItem={cosmetico => <CardCosmetico cosmetico={cosmetico} />}/>
                <SessionTitle>SÉRUNS FACIAL</SessionTitle>
                <FlatList showsHorizontalScrollIndicator={false} style={styles.section} horizontal data={dadosSerum} renderItem={cosmetico => <CardCosmetico cosmetico={cosmetico} />}/>
                <Pressable onPress={() => navigate('Itens')}>
                    <SessionTitle>SABONETES</SessionTitle>
                </Pressable>
                <FlatList showsHorizontalScrollIndicator={false} style={styles.section} horizontal data={dadosSabonete} renderItem={cosmetico => <CardCosmetico cosmetico={cosmetico} />}/>
            </View>
 </ScrollView>
